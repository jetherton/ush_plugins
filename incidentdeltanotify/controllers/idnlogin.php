...
/**
 * Incident delta notify controller. Handles login requests and make sure the user is redirected to the proper page
 *
 * @author	   John Etherton <john@ethertontech.com> 
 * @package	   Incident delta notify - http://ethertontech.com
 */

class Idnlogin_Controller extends Template_Controller {
