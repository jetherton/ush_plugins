...
class zdsadminalerts {
	...
	public function add()
	{
		...
		/** the profile controller doesn't have any events associated with it, so right now it's pretty worthless for us
		 * I submitted a feature request to Ushahidi and hope to have the requsite events in there soon.
