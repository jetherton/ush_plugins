<?php
/**
 * Score view. Lets admins see their score
...
?>
			<div class="bg">
				<h2><?php echo Kohana::lang('score.score_title'); ?></h2>
				...
				<?php print form::open(NULL, array('id' => 'reportMain', 'name' => 'reportMain')); ?>				
					...
					<h3><?php echo Kohana::lang('score.your_score')?></h3>
					<table id="myscore_table">
					<tr><td>+</td><td class="score_variable"><?php echo Kohana::lang('score.your_ideas').': <strong>'. count($your_ideas);?></strong> </td><td>X 10 </td></tr>
					<tr><td>+</td><td class="score_variable"><?php echo Kohana::lang('score.votes_for_your_ideas').': <strong>'. $your_ideas_votes;?></strong></td><td>X 2 </td></tr>
					<tr><td>+</td><td class="score_variable"><?php echo Kohana::lang('score.your_votes_ideas'). ': <strong>'. count($your_votes);?></strong></td><td> </td></tr>
					<tr><td  class="score_sum">=</td><td class="score_variable score_sum"><?php echo Kohana::lang('score.your_score'). ': <strong>'. ((count($your_ideas) * 10) + ($your_ideas_votes*2)+count($your_votes));?></strong></td><td class="score_sum"></td></tr>
					</table>
					<br/>
					<br/>
					<br/>
					<h3><?php echo Kohana::lang('score.ideas_you_have_voted_for')?></h3>
					<table class="table">
							<thead>
								<tr>
									<th class="col-1 col-1_score"><?php echo Kohana::lang('score.for/against');?></th>
									<th class="col-2"><?php echo Kohana::lang('ui_main.reports');?></th>
									<th class="col-4"></th>
								</tr>
							</thead>
							<tbody>
							<?php if (count($your_votes) == 0): ?>
								<tr>
									<td colspan="4" class="col">
										<h3><?php echo Kohana::lang('score.no_ideas');?></h3>
									</td>
								</tr>
							<?php endif; ?>
							<?php
								foreach ($your_votes as $incident)
								{
									...
									//$votes_for = $your_ideas_scores[$incident_id]['for'];
									//$votes_against = $your_ideas_scores[$incident_id]['against'];
									?>
									<tr>
										<td class="col-1">
										<?php echo $incident->vote == 1 ? Kohana::lang('score.for') : Kohana::lang('score.against');?>										
										</td>
										<td class="col-2">
											<div class="post">
												<h4>
					...
					<br/>
					<br/>
					<h3><?php echo Kohana::lang('score.score_of_your_ideas')?></h3>
					
						<table class="table">
							<thead>
								<tr>
									<th class="col-1 col-1_score"><?php echo Kohana::lang('score.score_title');?></th>
									<th class="col-2"><?php echo Kohana::lang('ui_main.reports');?></th>
									<th class="col-4"><?php echo Kohana::lang('ui_main.actions');?></th>
								</tr>
							</thead>
							<tbody>
							<?php if (count($your_ideas) == 0): ?>
								<tr>
									<td colspan="4" class="col">
										<h3><?php echo Kohana::lang('score.no_ideas');?></h3>
									</td>
							...
							<?php endif; ?>
							<?php
								foreach ($your_ideas as $incident)
								{
									$incident_id = $incident->id;
									$incident_title = strip_tags($incident->incident_title);
									$incident_description = text::limit_chars(strip_tags($incident->incident_description), 150, "...", true);
									...
									<tr>
										<td class="col-1">
										<?php echo Kohana::lang('score.for') . ': '. $votes_for;?>
										<br/>
										<?php echo Kohana::lang('score.against') . ': '. $votes_against;?>
										</td>
										<td class="col-2">
											<div class="post">
												<h4>
										...
										<td class="col-4">
											<ul>
														...
														<li class="none-separator"><a href="<?php echo url::base(). 'members/reports/edit/'.$incident_id;?>"><?php echo Kohana::lang('ui_main.edit')?></a></li>
