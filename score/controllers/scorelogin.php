...
/**
 * Score controller. Handles login requests and make sure the user is redirected to the proper page
 *
 * @author	   John Etherton <john@ethertontech.com>, with some help from the Ush team 
 * @package	   Score - http://ethertontech.com
 */

class scorelogin_Controller extends Template_Controller {
